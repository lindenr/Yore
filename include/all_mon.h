...
MONST("chicken", 'c', 12,
      ATTK(A(1,1,ATTK_BITE), A(1,1,ATTK_CLAW), AT_NONE,
           AT_NONE, AT_NONE, AT_NONE), FL_FLSH|FL_WING|FL_SIZ2, COL_TXT_RED|COL_TXT_GREEN|COL_TXT_BRIGHT,
      6),
MONST("crab", 'c', 12,
      ATTK(A(1,2,ATTK_CLAW), AT_NONE, AT_NONE,
	  AT_NONE, AT_NONE, AT_NONE), FL_FLSH|FL_ARMS|FL_LEGS, COL_TXT_RED|COL_TXT_GREEN,
	  4),
MONST("gnome", 'G', 10,
      ATTK(A(1,3,ATTK_HIT), AT_NONE, AT_NONE,
           AT_NONE, AT_NONE, AT_NONE), FL_HMND|FL_SIZ3, COL_TXT_RED|COL_TXT_GREEN,
      36),
MONST("human", '@', 12,
      ATTK(A(1,4,ATTK_HIT), AT_NONE, AT_NONE,
           AT_NONE, AT_NONE, AT_NONE), FL_HMND|FL_SIZ4, COL_TXT_BLUE|COL_TXT_RED|COL_TXT_GREEN,
      48),
MONST("dwarf", 'h', 10,
      ATTK(A(1,3,ATTK_HIT), AT_NONE, AT_NONE,
           AT_NONE, AT_NONE, AT_NONE), FL_HMND|FL_SIZ3, COL_TXT_RED,
      36),
MONST("hobbit", 'h', 10,
      ATTK(A(1,3,ATTK_HIT), AT_NONE, AT_NONE,
           AT_NONE, AT_NONE, AT_NONE), FL_HMND|FL_SIZ3, COL_TXT_GREEN,
      45),
MONST("lich", 'L', 8,
      ATTK(A(2,4,ATTK_HIT), A(2,2,AM(ATTK_MAGIC,ATYP_CURS)), AT_NONE,
           AT_NONE, AT_NONE, AT_NONE), FL_SKEL|FL_SIZ4, COL_TXT_RED|COL_TXT_BLUE,
      216),
MONST("acid blob", 'j', 6,
      ATTK(A(2,4,ATTK_TOUCH), A(3,2,AM(ATTK_PASS,ATYP_ACID)), AT_NONE,
           AT_NONE, AT_NONE, AT_NONE), FL_BLOB|FL_SIZ2, COL_TXT_GREEN,
      30),
MONST("Satan", 'D', 6,
      ATTK(A(3,5,ATTK_HIT), A(4,5,AM(ATTK_MAGIC,ATYP_BEAM)), AT_NONE,
           AT_NONE, AT_NONE, AT_NONE), FL_UNIQ|FL_SIZ5, COL_TXT_RED,
      1024),
MONST(NULL, 0, 0, ATTK(AT_NONE,AT_NONE,AT_NONE,AT_NONE,AT_NONE,AT_NONE), 0, 0, 0)
};
